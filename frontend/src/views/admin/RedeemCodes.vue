...
const openEdit = (row) => {
    ...
    form.value = {
        ...
        amount: selectedType.value === 'send_balance'
            && Number.isFinite(amount) && amount >= 1 && amount <= 1000000000
            ? amount
            : 1,
...
const save = async () => {
    if (form.value.type === 'role' && !form.value.role.trim()) return
    ...
    <div class="redeem-admin">
        ...
        <n-modal v-model:show="showEditor" preset="dialog"
            ...
            <n-form label-placement="top">
                ...
                <n-form-item v-if="form.type === 'role'" :label="t('role')">
